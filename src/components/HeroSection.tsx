  ...
  return <section className="pt-40 pb-20 bg-[#FFFBF6]">
      <div className="container px-6 mx-auto">
        <div className="flex flex-col items-center text-center max-w-6xl mx-auto">
          ...
          <p className="mt-10 text-xl md:text-2xl text-gray-600 max-w-4xl leading-relaxed">Automate your local marketing workflows with mktpk. Create, research, schedule, and distribute content—all tailored to your specific local context.</p>
